...
const getLayoutData = cache(async () => {
  ...
  return {
    ...
    footer: {
      ...
      // Customer Care links — support ticket link included
      customers: [
        { title: "Help Center",              url: "/support-tickets" },
        { title: "Track Your Order",         url: "/orders" },
        { title: "Contact Us",               url: `mailto:${storeConfig.email}` },
