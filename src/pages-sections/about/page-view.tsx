  ...
  return (
    <Container maxWidth="md" sx={{ py: { xs: 6, md: 9 } }}>
      ...
      <Section title="Who We Are">
        Prestige Apparel Group is a U.S.-based online boutique specializing in premium Italian-crafted apparel and
      ...
      <Section title="Our Story">
        Prestige Apparel Group was founded with a simple idea: bring the quality of Italian boutique fashion to
      ...
      >
        Prestige Apparel Group is operated by RGC4, a U.S.-based company.
      </Typography>
