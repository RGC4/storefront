  ...
  try {
    ...
    if (resendKey) {
      ...
      const customerHtml = `
        ...
        <p style="font-family:sans-serif">Thank you for contacting <strong>Prestige Apparel Group</strong>. We've received your message and will respond within <strong>1–2 business days</strong>.</p>
        ...
        <br/>
        <p style="font-family:sans-serif">Prestige Apparel Group<br/>Customer Support Team<br/><a href="mailto:${supportEmail}">${supportEmail}</a></p>
      `;
